  ...
  if (agreement.status === 'draft') {
    return (
      <div className="p-6">
        <VariantA
          agreement={agreement}
          tiers={tiers as { bracketCeiling: number | null; rateBps: number; sortOrder: number }[]}
        />
      </div>
    );
  }

  // Variant B will be added in P5.2
  // For non-draft, non-migration_pending_review, redirect back
  navigate('/billing');
  return null;
}
