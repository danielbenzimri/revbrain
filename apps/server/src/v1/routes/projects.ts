...
const createProjectSchema = z.object({
  ...
  contractDate: dateStringToDate,
  startDate: dateStringToDate,
  endDate: dateStringToDate,
  contractorName: z.string().max(255).nullable().optional(),
  contractorId: z.string().max(50).nullable().optional(),
  clientName: z.string().max(255).nullable().optional(),
  clientId: z.string().max(50).nullable().optional(),
  contractValueCents: z.number().int().min(0).optional(),
  globalDiscountPercent: z.number().min(0).max(100).optional(),
  chapterDiscounts: z.record(z.string(), z.number()).optional(),
...
const projectResponseSchema = z.object({
  ...
  globalDiscountPercent: z.number().nullable(),
  chapterDiscounts: z.any().nullable(),
