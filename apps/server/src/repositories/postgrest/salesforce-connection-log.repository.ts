...
export class PostgRESTSalesforceConnectionLogRepository implements SalesforceConnectionLogRepository {
  ...
  async create(data: CreateSalesforceConnectionLogInput): Promise<SalesforceConnectionLogEntity> {
    return insertOne<SalesforceConnectionLogEntity>(this.supabase, 'salesforce_connection_logs', {
